        ...
        <nav class="bg-gray-900 text-white py-3">
            <div class="container mx-auto flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2 ml-auto">
                    <div class="relative">
                        <button
                            class="bg-blue-500 rounded-full h-8 w-8 font-bold text-white text-sm flex items-center justify-center shadow-md">
                            +
                        </button>
                    </div>
                    <div class="relative">
                ...
                <div class="bg-white rounded-lg p-6 w-full max-w-md mx-auto shadow-lg">
                    ...
                    <div class="flex justify-end mt-4">
                        ...
                        <button id="saveButton"
                            class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700">Add Card</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="bg-white rounded-lg p-6 w-full max-w-md mx-auto shadow-lg">
                    ...
                    <div class="flex justify-between mt-4">
                        <button id="deleteButton"
                            class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-700">Delete Card</button>
                        <button id="saveEditButton"
                            class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700">Save Changes</button>
                    </div>
                </div>
            </div>
        </div>
